...
void ULuaLoad::LoadAll(lua_State* L)
{
	...
	UTableUtil::loadEnum(EWidgetTestAppearLocation_Enum, "EWidgetTestAppearLocation");
	...
	UTableUtil::loadEnum(EMaterialBakeMethod_Enum, "EMaterialBakeMethod");
	...
	UTableUtil::loadEnum(EGraphPanningMouseButton_Enum, "EGraphPanningMouseButton");
	...
	UTableUtil::loadEnum(EAutoChangeMode_Enum, "EAutoChangeMode");
	UTableUtil::loadEnum(EAllowEditsMode_Enum, "EAllowEditsMode");
	...
	UTableUtil::loadEnum(EPIEPreviewDeviceType_Enum, "EPIEPreviewDeviceType");
	...
	UTableUtil::loadEnum(ESteamVRTouchDPadMapping_Enum, "ESteamVRTouchDPadMapping");
	UTableUtil::loadEnum(ESpriteExtractMode_Enum, "ESpriteExtractMode");
	UTableUtil::loadEnum(EImportGeometryType_Enum, "EImportGeometryType");
	UTableUtil::loadEnum(EImportLODType_Enum, "EImportLODType");
